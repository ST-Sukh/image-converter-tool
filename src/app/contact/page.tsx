      ...
      <section className="space-y-6">
        <div>
          ...
          <p className="mt-3 text-base text-[color:var(--muted)]">
            ...
            settings or plan custom exports. This form is UI only and is not
            wired to a backend yet.
          </p>
        </div>

        <form className="space-y-4 rounded-3xl border border-black/10 bg-white/90 p-6 shadow-[var(--shadow-lg)]">
          <div>
          ...
          <button
            type="button"
            className="w-full rounded-full bg-[color:var(--foreground)] px-5 py-3 text-sm font-semibold text-white shadow-[var(--shadow-sm)]"
          >
            Save details
          </button>
        </form>
